package com.example.eroom.domain.chat.thymeleaf.interceptor;
...
@Component
public class ThymeleafProjectAccessInterceptor implements HandlerInterceptor {

    private final ProjectServiceEx projectServiceEx;

    public ThymeleafProjectAccessInterceptor(ProjectServiceEx projectServiceEx) {
